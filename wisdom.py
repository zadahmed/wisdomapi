...
app.config.update(dict(
    ...
    MAIL_USE_TLS = True,
    MAIL_USE_SSL = False,
    MAIL_USERNAME = 'support@wisdomai.co.uk',
...
def support():
    ...
    if request.method == "GET":
        ...
        subject = "Support! Subject: {}".format(subject)
        message = request.form['message']
        msg = Message(subject, sender="support@wisdomai.co.uk", recipients=["support@wisdomai.co.uk"])
...
def signup():
    ...
    if request.method == "GET":
        ...
        print(msg)
        # send welcome email
        email = Message("Welcome to Wisdom!",
